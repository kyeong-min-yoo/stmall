...
public class OrderMgmt {
    ...
    public static void updatStatus(DeliveryStarted deliveryStarted) {
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void updatStatus(DeliveryModified deliveryModified) {
        //implement business logic here:
        ...
        */
        ...
        // if deliveryModified.cjLogicsId exists, use it
        
        // ObjectMapper mapper = new ObjectMapper();
        // Map<, Object> deliveryMap = mapper.convertValue(deliveryModified.getCjLogicsId(), Map.class);

        repository().findById(deliveryModified.get???()).ifPresent(orderMgmt->{
